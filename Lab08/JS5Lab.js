 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting ('Stevie', 'MN')
myGreeting.hello()
/*-------------------------------------------------------*/
// Question 3: myBook
console.log(`--------------------------
...
let yourBook = new Book ('Dracula', 'Bram Stoker')
...
/* Look at the provided code below. Notice how Student and Teacher inherit from the Person class through the use of the "extends" and 
"super" key words. Also, how Student has a redefined details method that is more appropriate than the details method it would have 
inherited from the Person super class...*/
